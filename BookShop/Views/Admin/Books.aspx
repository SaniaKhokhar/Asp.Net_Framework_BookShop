<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Books.aspx.cs" Inherits="BookShop.Views.Admin.Books" %>
          ...
          <%--<div class="col-md-4">  </div>--%>  
            <div class="col-md-4">
                ...
                <div class="row">
                    ...
                    <div class="col d-grid"><asp:Button Text="Update"  runat="server" ID="UpdateBtn" CssClass="btn-warning btn-block btn" OnClick="UpdateBtn_Click"/></div>
                    <div class="col d-grid"><asp:Button Text="Save"  runat="server" ID="AddBtn" CssClass="btn-success btn-block  btn" OnClick="AddBtn_Click"/></div>
                    <div class="col d-grid"><asp:Button Text="Delete"  runat="server" ID="DeleteBtn" CssClass="btn-danger btn-block btn" OnClick="DeleteBtn_Click"/></div>
                </div>
            </div>  
