...
namespace BookShop.Views.Seller
{
    public partial class Selling : System.Web.UI.Page
    {
        ...
        {
            string Query = "Select BId as Code, BName as Name, BQty as Stock, BPrice as Price from BookTb where BQty > 0";
        ...
        private void InsertBill()
        {
            ...
            Query = string.Format(Query, DateTime.Today.Date.ToString(), Seller, Convert.ToInt32(GrdTotalTb.Text.Substring(2)));           
            Con.SetData(Query);
        }
