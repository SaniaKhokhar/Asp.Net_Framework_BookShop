<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Seller/SellerMaster.Master" AutoEventWireup="true" CodeBehind="Selling.aspx.cs" Inherits="BookShop.Views.Seller.Selling" %>
    ...
    <div class="container-fluid">
        <div class="row">
         ...
         <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col">
                         <div class="mt-3">
                            ...
                            <input type="text" placeholder="Book Price" autocomplete="off" class="form-control" id="BPriceTb" runat="server"/>
                        </div>
                    </div>
                 </div>
                  <div class="row">
                    ...
                    <div class="col">
                         <div class="mt-3"> 
                           ...
                           <input type="datetime" placeholder="Date" class="form-control" id="DateTb" runat="server"/>
                       </div> 
                   </div>
                      <div class="row mt-3">
                          <div class="col d-grid">
                              <asp:Label runat = "server" ID="ErrMsg" class="text-danger text-center"></asp:Label>
                              <asp:Button Text="Add To Bill"  runat="server" ID="AddToBillBtn" CssClass="btn-warning btn-block btn" OnClick="AddToBillBtn_Click"/>
                          </div>
                      </div>
                </div>
                  <div class="row mt-5">
             ...
             <div class="col-md-7">
                 <h3 class="text-center" style="color:crimson;">Client's Bill List</h3>
                <div class="col">
                    ...
                    <div class="d-grid">
                        ...
                        <asp:Button Text="Print"  runat="server" ID="PrintBtn" OnClientClick="PrintBill()" CssClass="btn-warning btn-block btn" OnClick="PrintBtn_Click"/>
                    </div>
                </div>
            </div>
        </div>
